...
CREATE TABLE INSTALACAO_RESERVAVEL(
    ...
    CONSTRAINT PK_INSTALACAO_RESERVAVEL PRIMARY KEY (BLOCO_ESPACO, NUMERO_ESPACO)
    CONSTRAINT FK_INSTALACAO_RESERVAVEL FOREIGN KEY (BLOCO_ESPACO, NUMERO_ESPACO)
...
CREATE TABLE INSTALACAO_NAO_RESERVAVEL(
    ...
    CONSTRAINT PK_INSTALACAO_NAO_RESERVAVEL PRIMARY KEY (BLOCO_ESPACO, NUMERO_ESPACO)
    CONSTRAINT FK_INSTALACAO_NAO_RESERVAVEL FOREIGN KEY (BLOCO_ESPACO, NUMERO_ESPACO)
        REFERENCES ESPACO (BLOCO, NUMERO)
            ON DELETE CASCADE ON UPDATE CASCADE,
)
